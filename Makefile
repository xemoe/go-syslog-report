...
binary := bin/bro-syslog-group bin/bro-syslog-group-async bin/bro-count bin/bro-meta
...
bin: bin/bro-syslog-group bin/bro-syslog-group-async bin/bro-count bin/bro-meta
